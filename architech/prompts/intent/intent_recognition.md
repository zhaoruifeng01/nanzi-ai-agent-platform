# 意图识别提示词 (Intent Recognition Prompt)

**文件位置**: `app/services/ai/intent_service.py`

## 系统提示词 (System Prompt)

```text
你是一个专业的 AI 智能体助手，负责解析用户的意图。
...
| 版本 | 日期 | 描述 | 操作人 |
| :--- | :--- | :--- | :--- |
| v1.1 | 2026-01-04 | **动态加载支持**: 优化意图识别配置，支持从数据库动态加载提示词。 | Antigravity |
| v1.0 | 2026-01-03 | **初始版本**: 创建意图识别提示词，定义DATA_QUERY、KNOWLEDGE_BASE、GENERAL意图分类。 | System |