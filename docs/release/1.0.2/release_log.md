...
* 📦 **Source Code (zip)**: `nanzi-ai-agent-platform-1.0.2.zip`
* 📦 **Source Code (tar.gz)**: `nanzi-ai-agent-platform-1.0.2.tar.gz`
* 🐳 **Docker Image for Linux amd64 (x86_64)**: `nanzi-ai-agent_1.0.2_linux-amd64_*.tar`
