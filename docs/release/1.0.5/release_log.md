...
* 📦 **Source Code (zip)**: `yunshu-ai-agent-platform-1.0.5.zip`
* 📦 **Source Code (tar.gz)**: `yunshu-ai-agent-platform-1.0.5.tar.gz`
* 🐳 **Docker Image for Linux amd64 (x86_64)**: `yunshu-ai-agent_1.0.5_linux-amd64_*.tar`
* 🐳 **Docker Image for Linux arm64 (aarch64)**: `yunshu-ai-agent_1.0.5_linux-arm64_*.tar`
