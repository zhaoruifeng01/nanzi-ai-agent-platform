...
from app.services.workbench_home_service import WorkbenchHomeService


router = APIRouter()


@router.get("/home", response_model=StandardResponse[Dict[str, Any]], summary="获取个人业务工作台")
async def get_workbench_home(
    ...
    payload = await WorkbenchHomeService.build(
        db,
        user_id=user_id,
        role_ids=role_ids,
        user=user_info,
